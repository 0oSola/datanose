...
(function(){
	...
	$(function(){
		...
		lineName = ["增加量","激活量"];
		yname = "人数";
		areaChart(data,xName,yname,lineName,"add-chart");*/
		
		//init
		dataLoader.loadList(".add-content");
		dataLoader.loadList(".first-content");
