...
(function(){
	...
	$(function(){
		...
		//init
		dataLoader.loadList(".retain-nomral");
		
		
		eventsManager.searchData();
		eventsManager.typeSearch();
		eventsManager.retainType();
	...
	var eventsManager = {
		...
		//留存类型切换
		retainType:function(){
			$(".retain-btn").off("click");
			$(".retain-btn").on("click",function(){
				$(".retain-btn").removeClass("select");
				$(this).addClass("select");
				var type = $(this).attr("data-target");
				$(".retain-type").css("display","none");
